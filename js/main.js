...
const endGame = () => {
    ...
    displayWord(wordMapping);
    document.querySelector('body').style.backgroundColor = 'color: red;';
    els.choices.innerHTML = `<p> TU AS PERDU ! </p>
    <div class=js-mode><div class="js-one"><a href="index.html"><img src="image/Retry.png"></a><a href="Accueil.html"><img src="image/Home.png"></a></div>`;
};
const winGame = () => {
    document.querySelector('body').style.backgroundColor = 'color: green;';
    els.choices.innerHTML = `<p> TU AS GAGNÉ ! </p>
    <div class=js-mode><div class="js-one"><a href="index.html"><img src="image/Retry.png"></a><a href="Accueil.html"><img src="image/Home.png"></a></div>`;
}
